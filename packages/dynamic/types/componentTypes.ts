...
export const dynamicComponentTypes: Array<DynamicComponentType> = [
    ...
    { componentName: 'ElsAceEditor',icon:'text-style', label: 'Ace编辑器', value: 'AceEditor', type: "AceEditor", dataTypes: ['String'], defaultPropertys: {}, propertys: property_aceEditor, group: 'Form', formItem: true, isShow: true },
   
    { componentName: 'ElsRow',icon:'layout-two', label: '栅格行', value: 'Row', type: "Row", dataTypes: ['None'], defaultPropertys: {}, propertys: property_row, group: 'Container', formItem: false, isShow: true },
    { componentName: 'ElsCol', icon:'margin', label: '栅格列', value: 'Col', type: "Col", dataTypes: ['None'], defaultPropertys: {}, propertys: property_col, group: 'Container', restrictParent: 'Row', formItem: false, isShow: true },
    { componentName: 'ElsTabs',icon:'label', label: 'Tabs标签页', value: 'Tabs', type: "Tabs", dataTypes: ['String', 'Number'], defaultPropertys: {}, propertys: property_tabs, group: 'Container', restrictChild: 'TabPane', formItem: true, isShow: true },
    { componentName: 'ElsOption',icon:'bookmark', label: 'Tabs选项', value: 'TabPane', type: "Option", dataTypes: ['None'], defaultPropertys: {}, propertys: property_tabPane, group: 'Container', restrictParent: 'Tabs', formItem: true, isShow: true },
   
    { componentName: 'ElsForm',icon:'form-one', label: 'Form表单', value: 'Form', type: "Form", dataTypes: ['None'], defaultPropertys: {}, propertys: property_form, group: 'Container', formItem: false, isShow: false },
    { componentName: 'ElCollapse',icon:'menu-unfold', label: '折叠面板', value: 'Collapse', type: "Collapse", dataTypes: ['None'], defaultPropertys: {}, propertys: property_collapse, group: 'Container', restrictChild: 'CollapseItem', formItem: false, isShow: true },
    { componentName: 'ElCollapseItem',icon:'hamburger-button', label: '折叠节点', value: 'CollapseItem', type: "CollapseItem", dataTypes: ['None'], defaultPropertys: {}, propertys: property_collapseItem, group: 'Container', restrictParent: 'Collapse', formItem: false, isShow: true },
    { componentName: 'ElCard',icon:'bank-card', label: 'Card卡片', value: 'Card', type: "Card", dataTypes: ['None'], defaultPropertys: {}, propertys: property_card, group: 'Container', formItem: false, isShow: true },
    { componentName: 'ElsFormItem',icon:'form-one', label: 'Form表单项', value: 'FormItem', type: "FormItem", dataTypes: ['None'], defaultPropertys: {}, propertys: property_formItemCom, group: 'Container', formItem: false, isShow: true },
    { componentName: 'div',icon:'code', label: 'Div标签', value: 'Html', type: "Html", dataTypes: ['None'], defaultPropertys: {}, propertys: [], group: 'Container', formItem: false, isShow: true },

    { componentName: 'ElsCaption',icon:'dividing-line', label: '分隔描述', value: 'Caption', type: "Caption", dataTypes: ['None', 'String'], defaultPropertys: {}, propertys: property_caption, group: 'Show', formItem: true, isShow: true },
    { componentName: 'ElsTip',icon:'tips', label: '页面提示', value: 'Tip', type: "Tip", dataTypes: ['None'], defaultPropertys: {}, propertys: property_tip, group: 'Show', formItem: false, isShow: true },
    { componentName: 'ElAlert',icon:'topic-discussion', label: 'Alert提示', value: 'Alert', type: "Alert", dataTypes: ['None'], defaultPropertys: {}, propertys: property_alert, group: 'Show', formItem: false, isShow: true },
    { componentName: 'ElButton',icon:'button', label: 'Button按钮', value: 'Button', type: "Button", dataTypes: ['None'], defaultPropertys: {}, propertys: property_button, group: 'Show', formItem: false, isShow: true },
