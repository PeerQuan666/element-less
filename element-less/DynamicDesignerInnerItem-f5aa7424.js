import { defineComponent, ref, computed, watch, resolveComponent, openBlock, createElementBlock, Fragment, createVNode, unref, isRef, normalizeClass, withCtx, createBlock, toDisplayString, createCommentVNode, createSlots, createElementVNode, createTextVNode, nextTick } from "vue";
import { l as lessCom, p as property_arrayAndObject, D as DynamicDesignerInner, a as property_array, b as property_formItem, c as property_advanced, u as useValue, _ as _export_sfc } from "./index-7e085f40.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const emits = __emit;
    const camelCase = getValue("camelCase", false);
    const settingDirection = getValue("settingDirection");
    const allowCreateType = getValue("allowCreateType", false);
    const allowCreateComponent = getValue("allowCreateComponent", false);
    const openCreateType = getValue("openCreateType", () => null);
    const openCreateComponent = getValue("openCreateComponent", () => null);
    const componentSettingVisible = getValue("componentSettingVisible", true);
    const columnVisible = getValue("columnVisible", () => {
      return true;
    });
    const dataTypeData = getValue("dataTypeData", null);
    const controlData = getValue("componentData", null);
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(_component_els_form, {
          ...
          "onUpdate:modelValue": _cache[14] || (_cache[14] = ($event) => isRef(currItem) ? currItem.value = $event : null),
          labelWidth: "0",
          inputWidth: "100%",
          ...
          default: withCtx(() => [
            !isRow.value ? (openBlock(), createElementBlock("div", {
              key: 0,
              class: normalizeClass(["els-dynamic-d-item-div", [{ "setting": attrDrawVisible.value }]])
            }, [
              unref(columnVisible)("keyName") ? (openBlock(), createElementBlock("span", _hoisted_1, [
                itemDataType.value.type != "None" || _ctx.item.componentType === "Caption" ? (openBlock(), createBlock(_component_els_input, {
                  key: 0,
                  clearable: "",
                  placeholder: "请输入名称",
                  prop: "keyName"
                })) : unref(currItem).config.baseConfig ? (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(unref(currItem).config.baseConfig.title), 1)) : createCommentVNode("", true)
              ])) : createCommentVNode("", true),
              unref(columnVisible)("keyCode") ? (openBlock(), createElementBlock("span", _hoisted_3, [
              ...
              unref(columnVisible)("dataType") ? (openBlock(), createElementBlock("span", _hoisted_4, [
              ...
              unref(componentSettingVisible) ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [
                unref(columnVisible)("componentType") ? (openBlock(), createElementBlock("span", _hoisted_15, [
                ...
                unref(columnVisible)("config") ? (openBlock(), createElementBlock("span", _hoisted_16, [
              ...
              unref(columnVisible)("required") ? (openBlock(), createElementBlock("span", _hoisted_17, [
              ...
              unref(columnVisible)("description") ? (openBlock(), createElementBlock("span", _hoisted_18, [
                itemDataType.value.type !== "None" ? (openBlock(), createBlock(_component_els_input, {
                  key: 0,
                  placeholder: "描述",
                  clearable: "",
              ...
              unref(columnVisible)("defaultValue") ? (openBlock(), createElementBlock("span", _hoisted_19, [
              ...
              unref(columnVisible)("oper") ? (openBlock(), createElementBlock("span", _hoisted_20, [
                createElementVNode("span", _hoisted_21, [
                  ...
                  createVNode(_component_el_popconfirm, {
                    title: "确定删除吗？",
                    onConfirm: _cache[12] || (_cache[12] = ($event) => handleRemove(_ctx.item))
                  }, {
                    reference: withCtx(() => [
            ...
            isObject.value && !unref(currItem).componentType || isRow.value ? (openBlock(), createBlock(DynamicDesignerInner, {
              key: 1,
              data: unref(currItem).data,
              onRemoveItem: _cache[13] || (_cache[13] = ($event) => handleRemove(_ctx.item)),
        ...
        createVNode(_component_els_drawer, {
          modelValue: attrDrawVisible.value,
          "onUpdate:modelValue": _cache[19] || (_cache[19] = ($event) => attrDrawVisible.value = $event),
          title: "设置属性",
          direction: unref(settingDirection),
          initBody: true,
          class: "work-flow-drawer",
          size: "30%",
          "show-close": false,
          "append-to-body": "",
          "lock-scroll": false
            ...
            createVNode(_component_els_form, { labelWidth: "120" }, {
              default: withCtx(() => [
                createVNode(_component_el_tabs, null, {
                  default: withCtx(() => [
                    unref(currItem).componentType ? (openBlock(), createBlock(_component_el_tab_pane, {
                      key: 0,
                      label: "组件属性"
                    }, {
                      default: withCtx(() => {
                        ...
                        return [
                          createVNode(_component_ElsDynamicRender, {
                            ...
                            "onUpdate:modelValue": _cache[15] || (_cache[15] = ($event) => unref(currItem).config.baseConfig = $event),
                    ...
                    itemDataType.value.type == "Array" ? (openBlock(), createBlock(_component_el_tab_pane, {
                      ...
                      default: withCtx(() => [
                        createVNode(_component_ElsDynamicRender, {
                          ...
                          "onUpdate:modelValue": _cache[16] || (_cache[16] = ($event) => unref(currItem).config.arrayConfig = $event),
                    ...
                    itemDataType.value.type != "None" ? (openBlock(), createBlock(_component_el_tab_pane, {
                      ...
                      default: withCtx(() => [
                        createVNode(_component_ElsDynamicRender, {
                          ...
                          "onUpdate:modelValue": _cache[17] || (_cache[17] = ($event) => unref(currItem).config.formConfig = $event),
                          config: unref(property_formItem),
                          inputWidth: "100%"
                        }, null, 8, ["modelValue", "config"])
                      ]),
                      _: 1
                    ...
                    createVNode(_component_el_tab_pane, { label: "高级属性" }, {
                      default: withCtx(() => [
                        createVNode(_component_ElsDynamicRender, {
                          ...
                          "onUpdate:modelValue": _cache[18] || (_cache[18] = ($event) => unref(currItem).config.advancedConfig = $event),
...
const DynamicDesignerInnerItem_vue_vue_type_style_index_0_scoped_14fb4075_lang = "";
const DynamicDesignerInnerItem = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-14fb4075"]]);
export {
  DynamicDesignerInnerItem as default
};
