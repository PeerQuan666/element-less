import { defineComponent, inject, ref, computed, watch, resolveComponent, openBlock, createBlock, unref, isRef, normalizeClass, withCtx, createElementBlock, createElementVNode, createCommentVNode, createVNode, createTextVNode } from "vue";
import { l as lessCom, p as property_arrayAndObject, a as property_array, b as property_form, c as property_advanced, _ as _sfc_main$1 } from "./index-302d858e.js";
...
const _hoisted_5 = { class: "controlType" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_els_form, {
        ...
        default: withCtx(() => [
          ...
          isObject.value || isRow.value ? (openBlock(), createBlock(_sfc_main$1, {
            key: 1,
