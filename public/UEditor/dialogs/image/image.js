    ...
    function setTabFocus(id) {
        ...
        switch (id) {
            ...
            case 'upload':
                ...
                $G("IsWaterMark").checked = editor.getOpt('isWaterMark')
            ...
            uploader.on('all', function (type, files) {
                switch (type) {
                    ...
                    case 'startUpload':
                        ...
                        /*wxnt*/
                        url = url + "&IsWaterMark=" + $G("IsWaterMark").checked + "&HorizontalAlign=" + $G("HorizontalAlign").value + "&VerticalAlign=" + $G("VerticalAlign").value;
