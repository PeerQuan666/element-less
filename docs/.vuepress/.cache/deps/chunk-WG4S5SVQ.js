...
var cloneableTags = {};
cloneableTags[argsTag] = cloneableTags[arrayTag] = cloneableTags[arrayBufferTag2] = cloneableTags[dataViewTag2] = cloneableTags[boolTag2] = cloneableTags[dateTag2] = cloneableTags[float32Tag2] = cloneableTags[float64Tag2] = cloneableTags[int8Tag2] = cloneableTags[int16Tag2] = cloneableTags[int32Tag2] = cloneableTags[mapTag3] = cloneableTags[numberTag2] = cloneableTags[objectTag2] = cloneableTags[regexpTag2] = cloneableTags[setTag3] = cloneableTags[stringTag2] = cloneableTags[symbolTag3] = cloneableTags[uint8Tag2] = cloneableTags[uint8ClampedTag2] = cloneableTags[uint16Tag2] = cloneableTags[uint32Tag2] = true;
...
var nativeObjectToString = objectProto16.toString;
...
var nativeObjectToString2 = objectProto17.toString;
var invertBy = createInverter_default(function(result2, value, key) {
  if (value != null && typeof value.toString != "function") {
    value = nativeObjectToString2.call(value);
  }
  if (hasOwnProperty15.call(result2, value)) {
...
function isSafeInteger(value) {
  return isInteger_default(value) && value >= -MAX_SAFE_INTEGER2 && value <= MAX_SAFE_INTEGER2;
}
...
function customDefaultsAssignIn(objValue, srcValue, key, object) {
  if (objValue === void 0 || eq_default(objValue, objectProto18[key]) && !hasOwnProperty16.call(object, key)) {
    return srcValue;
  }
  return objValue;
}
...
function template(string, options, guard) {
  ...
  var sourceURL = hasOwnProperty17.call(options, "sourceURL") ? "//# sourceURL=" + (options.sourceURL + "").replace(/\s/g, " ") + "\n" : "";
  ...
  source += "';\n";
  var variable = hasOwnProperty17.call(options, "variable") && options.variable;
  if (!variable) {
    source = "with (obj) {\n" + source + "\n}\n";
...
mixin2(wrapperLodash_default, function() {
  ...
  baseForOwn_default(wrapperLodash_default, function(func, methodName) {
    if (!hasOwnProperty18.call(wrapperLodash_default.prototype, methodName)) {
...
baseForOwn_default(LazyWrapper_default.prototype, function(func, methodName) {
  ...
  if (lodashFunc) {
    ...
    if (!hasOwnProperty18.call(realNames_default, key)) {
...
lodash-es/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WG4S5SVQ.js.map
